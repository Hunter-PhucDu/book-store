            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {books.filter((book) => book.stock > 0 && book.stock <= 5).length}
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="md:col-span-2">
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="mt-2">
                          <CategoryBadges categoryIds={selectedBook.categories || []} />
                        </div>
                      </div>
                        ...
                        {categories && categories.map((category) => (
                          <div key={category.id} className="flex items-center mb-2">
                            <input
                              ...
                              checked={bookFormData.categories.includes(category.id)}
                              onChange={(e) => {
                                if (e.target.checked) {
                                  setBookFormData({
                                    ...bookFormData,
                                    categories: [...bookFormData.categories, category.id]
                                  });
                                } else {
                                  setBookFormData({
                                    ...bookFormData,
                                    categories: bookFormData.categories.filter(id => id !== category.id)
                                  });
                                }
                              }}
                            ...
                            >
                              ...
                              <button
                                ...
                                onClick={() => {
                                  setBookFormData({
                                    ...bookFormData,
                                    categories: bookFormData.categories.filter(id => id !== catId)
                                  });
                                }}
